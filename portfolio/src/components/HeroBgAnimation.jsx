...
const HeroBgAnimation = () => (
  <div className="absolute top-0 bottom-0 left-0 right-0 w-full h-full overflow-hidden z-0 flex justify-center items-center">
    <svg
      className="BgAnimation__svg w-full h-full"
      viewBox="0 0 602 602"
      fill="none"
